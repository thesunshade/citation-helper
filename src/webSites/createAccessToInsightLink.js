...
// The ATI links are name based so they can't be calculated the same way
//
// This should probably refactored so the same function can be used for ABT and PA

import { structure } from "../structure.js";
import { accessToInsight as website } from "./accessToInsight.js";

export default function createAccessToInsightLink(props) {
